#include <dwl_rviz_plugin/StabilityTrajectoryDisplay.h>
...
StabilityTrajectoryDisplay::StabilityTrajectoryDisplay()
{
	// Category Groups
...
void StabilityTrajectoryDisplay::onInitialize()
{
	MFDClass::onInitialize();
}


void StabilityTrajectoryDisplay::updateCoMRadiusAndAlpha()
{
...
void StabilityTrajectoryDisplay::updateCoPRadiusAndAlpha()
{
...
void StabilityTrajectoryDisplay::updatePendulumArrowGeometry()
{
...
void StabilityTrajectoryDisplay::processMessage(const dwl_msgs::StabilityTrajectory::ConstPtr& msg)
{
	...
	for (unsigned int k = 0; k < msg->trajectory.size(); k++) {
		dwl_msgs::StabilityState state = msg->trajectory[k];
